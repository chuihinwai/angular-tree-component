(function (global, factory) {
	...
	(factory((global['angular-tree-component'] = global['angular-tree-component'] || {}),global._angular_core,global._angular_common));
...
var mobx_1 = mobx.extras;
var mobx_2 = mobx.action;
var mobx_5 = mobx.autorun;
var mobx_8 = mobx.reaction;
var mobx_9 = mobx.computed;
var mobx_18 = mobx.observable;
var mobx_30 = mobx.spy;
var mobx_36 = mobx.isObservableArray;
var mobx_40 = mobx.isObservableObject;
...
var ng2MobxDebug = (function () {
    ...
    mobx_30(function (change) { return isDebugOn() && consoleLogChange(change, function () { return true; }); });
    ...
    function ng2MobxDebug(view, renderer, observer) {
        ...
        renderer.listen(debugElement, 'click', function () {
            console.log(mobx_1.getDependencyTree(observer));
        });
    }
    /////////////////////////////////////////////////////////
    ...
    function observableName(object) {
        return mobx_1.getDebugName(object);
    }
...
MobxAutorunDirective = __decorate$2([
...
MobxAutorunSyncDirective = __decorate$3([
...
var MobxReactionDirective = (function (_super) {
    ...
    MobxReactionDirective.prototype.autoDetect = function (view) {
        this.dispose = mobx_8(this.mobxReaction, function () {
            view['detectChanges']();
...
MobxReactionDirective = __decorate$4([
...
function observable$$1() {
    ...
    return mobx_18.apply(void 0, args);
}
function computed$$1() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
    ...
    return mobx_9.apply(void 0, args);
}
...
var TreeNode = (function () {
    ...
    TreeNode.prototype.setField = function (key, value$$1) {
        this.data[this.options[key + "Field"]] = value$$1;
    };
    // traversing:
    ...
    TreeNode.prototype.setIsExpanded = function (value$$1) {
        if (this.hasChildren) {
            this.treeModel.setExpandedNode(this, value$$1);
            if (!this.children && this.hasChildren && value$$1) {
    ...
    TreeNode.prototype.setIsActive = function (value$$1, multi) {
        if (multi === void 0) { multi = false; }
        this.treeModel.setActiveNode(this, value$$1, multi);
        if (value$$1) {
            this.focus();
        }
        return this;
    ...
    TreeNode.prototype.setIsHidden = function (value$$1) {
        this.treeModel.setIsHidden(this, value$$1);
    };
...
exports.TreeModel = TreeModel_1 = (function () {
    ...
    TreeModel.prototype.getFirstRoot = function (skipHidden) {
        if (skipHidden === void 0) { skipHidden = false; }
        return head(skipHidden ? this.getVisibleRoots() : this.roots);
    };
    ...
    TreeModel.prototype.setFocus = function (value$$1) {
        TreeModel_1.focusedTree = value$$1 ? this : null;
    };
    ...
    TreeModel.prototype.setActiveNode = function (node, value$$1, multi) {
        if (multi === void 0) { multi = false; }
        if (multi) {
            this._setActiveNodeMulti(node, value$$1);
        }
        else {
            this._setActiveNodeSingle(node, value$$1);
        }
        if (value$$1) {
            node.focus();
    ...
    TreeModel.prototype.setExpandedNode = function (node, value$$1) {
        this.expandedNodeIds = Object.assign({}, this.expandedNodeIds, (_a = {}, _a[node.id] = value$$1, _a));
        this.fireEvent({ eventName: TREE_EVENTS.onToggleExpanded, node: node, isExpanded: value$$1 });
        var _a;
    };
    ...
    TreeModel.prototype.setIsHidden = function (node, value$$1) {
        this.hiddenNodeIds = Object.assign({}, this.hiddenNodeIds, (_a = {}, _a[node.id] = value$$1, _a));
        var _a;
    };
    ...
    TreeModel.prototype.filterNodes = function (filter$$1, autoShow) {
        ...
        if (isString(filter$$1)) {
            filterFn = function (node) { return node.displayField.toLowerCase().indexOf(filter$$1.toLowerCase()) !== -1; };
        }
        else if (isFunction(filter$$1)) {
            filterFn = filter$$1;
        }
        else {
            console.error('Don\'t know what to do with filter', filter$$1);
    ...
    TreeModel.prototype._setActiveNodeSingle = function (node, value$$1) {
        var _this = this;
    ...
    TreeModel.prototype._setActiveNodeMulti = function (node, value$$1) {
        this.activeNodeIds = Object.assign({}, this.activeNodeIds, (_a = {}, _a[node.id] = value$$1, _a));
        var _a;
    };
    return TreeModel;
}());
...
exports.TreeModel = TreeModel_1 = __decorate$5([
...
exports.TreeDraggedElement = __decorate$7([
    _angular_core.Injectable()
...
exports.TreeVirtualScroll = (function () {
    function TreeVirtualScroll(treeModel) {
        ...
        this._dispose = mobx_5(function () { return _this.fixScroll(); });
    }
    ...
    TreeVirtualScroll.prototype.init = function () {
        ...
        fn();
        mobx_8(function () { return _this.treeModel.roots; }, fn);
        mobx_8(function () { return _this.treeModel.expandedNodeIds; }, fn);
        mobx_8(function () { return _this.treeModel.hiddenNodeIds; }, fn);
...
__decorate$8([
    mobx_2,
    __metadata$5("design:type", Function),
    __metadata$5("design:paramtypes", [Object, Object, Object]),
    __metadata$5("design:returntype", void 0)
], exports.TreeVirtualScroll.prototype, "scrollIntoView", null);
exports.TreeVirtualScroll = __decorate$8([
    _angular_core.Injectable(),
...
], exports.LoadingComponent.prototype, "node", void 0);
exports.LoadingComponent = __decorate$9([
...
exports.TreeComponent = (function () {
    ...
    Object.defineProperty(TreeComponent.prototype, "focused", {
        set: function (value$$1) {
            this.treeModel.setFocus(value$$1);
        },
        enumerable: true,
        configurable: true
    });
...
__decorate$10([
    _angular_core.Input(),
    __metadata$7("design:type", TreeOptions),
    __metadata$7("design:paramtypes", [TreeOptions])
...
exports.TreeComponent = __decorate$10([
    _angular_core.Component({
    ...
    __metadata$7("design:paramtypes", [exports.TreeModel,
        exports.TreeDraggedElement,
        _angular_core.Renderer,
...
exports.TreeNodeComponent = __decorate$11([
    _angular_core.Component({
...
__decorate$12([
    _angular_core.Input(),
    __metadata$9("design:type", _angular_core.TemplateRef)
], exports.TreeNodeContent.prototype, "template", void 0);
exports.TreeNodeContent = __decorate$12([
    _angular_core.Component({
...
exports.TreeNodeDropSlot = __decorate$13([
    _angular_core.Component({
...
exports.TreeNodeExpanderComponent = __decorate$14([
    _angular_core.Component({
...
exports.TreeNodeChildrenComponent = __decorate$15([
    _angular_core.Component({
...
exports.TreeNodeCollectionComponent = (function () {
    ...
    TreeNodeCollectionComponent.prototype.ngOnInit = function () {
        ...
        this._dispose = [
            ...
            mobx_8(function () { return _this.nodes; }, function (nodes) {
...
exports.TreeNodeCollectionComponent = __decorate$16([
    _angular_core.Component({
        selector: 'tree-node-collection, TreeNodeCollection',
        encapsulation: _angular_core.ViewEncapsulation.None,
        template: "\n    <ng-container *mobxAutorun>\n      <div\n        [style.margin-top]=\"marginTop\">\n        <tree-node\n          *ngFor=\"let node of viewportNodes; let i = index; trackBy: trackNode\"\n          [node]=\"node\"\n          [index]=\"i\"\n          [templates]=\"templates\">\n        </tree-node>\n      </div>\n    </ng-container>\n  "
    }),
    __metadata$13("design:paramtypes", [exports.TreeVirtualScroll, _angular_core.ElementRef])
...
exports.TreeViewportComponent = __decorate$17([
    _angular_core.Component({
...
exports.TreeDropDirective = __decorate$18([
    _angular_core.Directive({
        selector: '[treeDrop]'
    }),
    __metadata$15("design:paramtypes", [_angular_core.ElementRef, _angular_core.Renderer, exports.TreeDraggedElement])
...
exports.TreeDragDirective = __decorate$19([
    _angular_core.Directive({
        selector: '[treeDrag]'
    }),
    __metadata$16("design:paramtypes", [_angular_core.ElementRef, _angular_core.Renderer, exports.TreeDraggedElement])
